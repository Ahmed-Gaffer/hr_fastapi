# from typing import Optional  # استيراد Optional
# from datetime import date, datetime  # استيراد date و datetime
...
#     # تعديل __table_args__ لتعريف الفهارس بشكل صحيح
#     __table_args__ = (
#         Index("ix_salary_record_employee_id", "employee_id"),  # مثال على تعريف فهرس
#     )