...
class CompanyConfig(SQLModel, table=True):
    ...
    # 🔧 إعدادات الراتب
    personal_exemption_annual: float = 15000
    insurance_social_employee_rate: float = 0.10
    insurance_health_rate: float = 0.0
    insurance_employer_social_rate: float = 0.1475
    insurance_employer_health_rate: float = 0.04
    ...
    # 🔧 إعدادات الغياب
    absence_deduction_type: str = "percentage"
    absence_deduction_value: float = 1.0
    ...
    advance_salary_max_percentage: float = 0.5
